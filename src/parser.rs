use std::num::ParseFloatError;//replace with custom error
use std::fmt;//completly replace. this may be a pain in the ass
use std::io;//replace with my built in print! and println!
use std::collections::HashMap; //port to my own HashMap system, or to BTreeMap
use std::rc::Rc;//this is fine, replace with alloc::rc

/*

Needs to create a Fn()-> Result<Success,ProgramError> that has all of the execution
information, then kernal can add a cmd:String, Fn()-> Result<Success,ProgramError> to commands
